...
import com.vyommaitreya.android.scienceup.dialogs.AcademicsAssignmentAddDialogue;

import java.util.ArrayList;

public class AcademicsAssignmentsFragment extends Fragment {
    ...
    private void proceed() {
        mFab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AcademicsAssignmentAddDialogue academicsAssignmentAddDialogue = new AcademicsAssignmentAddDialogue(getActivity(), mCourseID);
                academicsAssignmentAddDialogue.show();
            }
        });

        mRef.child("academics").child("assignments").child(mCourseID).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                mLinks.clear();
